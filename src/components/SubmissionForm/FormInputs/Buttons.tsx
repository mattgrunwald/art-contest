...
export const Buttons = ({
  ...
  return (
    <>
      <Input
        className="inline-flex w-[48%] cursor-pointer items-center justify-center gap-2 rounded-md bg-emerald-300 px-3 py-1.5 text-sm/6 font-semibold text-slate-950 shadow-inner shadow-white/10 hover:bg-emerald-400 focus:outline-none data-[open]:bg-gray-700 data-[focus]:outline-1 data-[focus]:outline-slate-600 dark:bg-emerald-700 dark:text-slate-50 hover:dark:bg-emerald-600"
        type="submit"
