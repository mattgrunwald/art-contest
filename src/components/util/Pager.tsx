  ...
  return (
    <div className="inline-flex">
      {previousPage > 0 ? (
        ...
        <ChevronLeftIcon className="size-5 pt-1 text-neutral-950 dark:text-neutral-50" />
      )}
      {text}
      {nextPage <= totalPages ? (
        ...
        <ChevronRightIcon className="size-5 pt-1 text-neutral-950 dark:text-neutral-50" />
      )}
    </div>
  )
}
